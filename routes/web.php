...
Route::get('blogs','HomepageController@blog')->name('view.blog');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa']], function () {
    ...
    // Barbers
    Route::delete('barbers/destroy', 'BarbersController@massDestroy')->name('barbers.massDestroy');
    Route::post('barbers/media', 'BarbersController@storeMedia')->name('barbers.storeMedia');
    Route::post('barbers/ckmedia', 'BarbersController@storeCKEditorImages')->name('barbers.storeCKEditorImages');
    ...
    Route::resource('discounts', 'DiscountsController', ['except' => ['create', 'store', 'edit', 'update']]);
